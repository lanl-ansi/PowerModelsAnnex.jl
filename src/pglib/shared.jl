...
constraint_thermal_limit_from(pm::PMs.GenericPowerModel, i::Int; scale = 1.0) = constraint_thermal_limit_from(pm, pm.cnw, pm.ccnd, i; scale=scale)
...
constraint_thermal_limit_to(pm::PMs.GenericPowerModel, i::Int; scale = 1.0) = constraint_thermal_limit_to(pm, pm.cnw, pm.ccnd, i; scale=scale)
