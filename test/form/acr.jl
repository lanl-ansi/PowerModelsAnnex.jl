...
@testset "test acr nl" begin
    @testset "3-bus case" begin
        pm = PMs.build_generic_model(case_files["case3"], NLACRPowerModel, PowerModels.post_opf)
    ...
    @testset "5-bus pjm case" begin
        pm = PMs.build_generic_model(case_files["case5"], NLACRPowerModel, PowerModels.post_opf)
    ...
    @testset "30-bus ieee case" begin
        pm = PMs.build_generic_model(case_files["case30"], NLACRPowerModel, PowerModels.post_opf)
