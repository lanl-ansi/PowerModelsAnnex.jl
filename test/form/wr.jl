...
@testset "test wr oa" begin
    @testset "3-bus case" begin
        pm = build_generic_model("../../PowerModels/test/data/matpower/case3.m", SOCWROAPowerModel, PowerModels.post_opf)
    ...
    @testset "5-bus pjm case" begin
        pm = build_generic_model("../../PowerModels/test/data/matpower/case5.m", SOCWROAPowerModel, PowerModels.post_opf)
    ...
    @testset "30-bus ieee case" begin
        pm = build_generic_model("../../PowerModels/test/data/matpower/case30.m", SOCWROAPowerModel, PowerModels.post_opf)
