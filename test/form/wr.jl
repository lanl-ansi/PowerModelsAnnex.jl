...
@testset "test wr oa" begin
    @testset "3-bus case" begin
        pm = PMs.build_model(case_files["case3"], SOCWROAPowerModel, PowerModels.post_opf)
    ...
    @testset "5-bus pjm case" begin
        pm = PMs.build_model(case_files["case5"], SOCWROAPowerModel, PowerModels.post_opf)
    ...
    @testset "30-bus ieee case" begin
        pm = PMs.build_model(case_files["case30"], SOCWROAPowerModel, PowerModels.post_opf)
