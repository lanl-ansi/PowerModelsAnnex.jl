...
@testset "test ac api" begin
    @testset "3-bus case" begin
        result = PowerModelsAnnex.run_opf_api(case_files["case3"], PMs.ACPPowerModel, ipopt_solver)
    ...
    @testset "5-bus pjm case" begin
        result = PowerModelsAnnex.run_opf_api(case_files["case5"], PMs.ACPPowerModel, ipopt_solver)
