...
@testset "test ac api" begin
    @testset "3-bus case" begin
        result = PowerModelsAnnex.run_api_opf(case_files["case3"], ACPPowerModel, ipopt_solver)
    ...
    @testset "5-bus pjm case" begin
        result = PowerModelsAnnex.run_api_opf(case_files["case5"], ACPPowerModel, ipopt_solver)
    ...
    @testset "30-bus ieee case" begin
        result = PowerModelsAnnex.run_api_opf(case_files["case30"], ACPPowerModel, ipopt_solver)
